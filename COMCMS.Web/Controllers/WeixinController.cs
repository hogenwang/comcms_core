...
namespace COMCMS.Web.Controllers
{
    public class WeixinController : HomeBaseController
    {
        [HttpGet]
        [ActionName("Index")]
        public ActionResult Get(PostModel postModel, string echostr, int id = 0)
        {
        ...
        //    string EncodingAESKey = cfg.EncodingAESKey;
        //    if (!CheckSignature.Check(postModel.Signature, postModel.Timestamp, postModel.Nonce, token))
        //    {
        //        return Content("参数错误！");
        //    }
        ...
        //        messageHandler.RequestDocument.Save(Path.Combine(logPath, string.Format("{0}_Request_{1}_{2}.txt", Utils.GetRandomChar(20),
        //            messageHandler.RequestMessage.FromUserName,
        //            messageHandler.RequestMessage.MsgType)));
        //        if (messageHandler.UsingEcryptMessage)
        //        {
        //            messageHandler.EcryptRequestDocument.Save(Path.Combine(logPath, string.Format("{0}_Request_Ecrypt_{1}_{2}.txt", Utils.GetRandomChar(20),
        //                messageHandler.RequestMessage.FromUserName,
        //                messageHandler.RequestMessage.MsgType)));
        //        }
        ...
        //        if (messageHandler.ResponseDocument != null)
        //        {
        //            messageHandler.ResponseDocument.Save(Path.Combine(logPath, string.Format("{0}_Response_{1}_{2}.txt", Utils.GetRandomChar(20),
        ...
        //        {
        //            //记录加密后的响应信息
        //            messageHandler.FinalResponseDocument.Save(Path.Combine(logPath, string.Format("{0}_Response_Final_{1}_{2}.txt", Utils.GetRandomChar(20),
        //                messageHandler.ResponseMessage.ToUserName,
        //                messageHandler.ResponseMessage.MsgType)));
        //        }
        ...
        //    {
        //        #region 异常处理
        //        XTrace.WriteLine("MessageHandler错误：{0}", ex.Message);
        //        return Content("");
        //        #endregion
        //    }
