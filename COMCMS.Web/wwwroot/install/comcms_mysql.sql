...
CREATE TABLE `admin`  (
  ...
  `ThisLoginTime` datetime NULL DEFAULT NULL COMMENT '本次登录时间',
...
CREATE TABLE `adminmenu`  (
  ...
  PRIMARY KEY (`Id`) USING BTREE
) ENGINE = InnoDB AUTO_INCREMENT = 40 CHARACTER SET = utf8mb4 COLLATE = utf8mb4_general_ci COMMENT = '后台菜单' ROW_FORMAT = DYNAMIC;
...
CREATE TABLE `adminmenuevent`  (
  ...
  PRIMARY KEY (`Id`) USING BTREE
) ENGINE = InnoDB AUTO_INCREMENT = 203 CHARACTER SET = utf8mb4 COLLATE = utf8mb4_general_ci COMMENT = '后台菜单对应的事件权限' ROW_FORMAT = DYNAMIC;
...
CREATE TABLE `adminroles`  (
  ...
  `AuthorizedArticleCagegory` longtext CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NULL COMMENT '已授权文章栏目',
  `AuthorizedCagegory` longtext CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NULL COMMENT '已授权商品栏目',
  `OnlyEditMyselfArticle` int(11) NULL DEFAULT NULL COMMENT '是否只允许编辑自己的文章',
  `OnlyEditMyselfProduct` int(11) NULL DEFAULT NULL COMMENT '是否只允许编辑自己的产品',
  PRIMARY KEY (`Id`) USING BTREE
...
CREATE TABLE `ads`  (
  ...
  `StartTime` datetime NULL DEFAULT NULL COMMENT '起始时间',
...
CREATE TABLE `article`  (
  ...
  `UpdateTime` datetime NULL DEFAULT NULL COMMENT '时间',
  `Location` varchar(100) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT NULL COMMENT '路径',
  `FilePath` varchar(100) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT NULL COMMENT '存放目录',
  `FileName` varchar(50) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NULL DEFAULT NULL COMMENT '文件名称',
  PRIMARY KEY (`Id`) USING BTREE
...
CREATE TABLE `articlecategory`  (
  ...
  `AllowIp` longtext CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NULL COMMENT 'IP地址限制。每一行一条记录，可以用“-”分割',
  PRIMARY KEY (`Id`) USING BTREE
...
CREATE TABLE `config`  (
  ...
  `LastCacheTime` datetime NULL DEFAULT NULL COMMENT '最后缓存时间',
...
CREATE TABLE `guestbook`  (
  ...
  `ReplyAddTime` datetime NULL DEFAULT NULL COMMENT '回复时间',
...
CREATE TABLE `member`  (
  ...
  `RePassWordTime` datetime NULL DEFAULT NULL COMMENT '找回密码时间',
...
CREATE TABLE `memberlog`  (
  ...
  `LastUpdateTime` datetime NULL DEFAULT NULL COMMENT '登录时间',
  PRIMARY KEY (`Id`) USING BTREE
...
CREATE TABLE `onlinepayorder`  (
  ...
  `AddTime` datetime NULL DEFAULT NULL COMMENT '添加时间',
  `ReceiveTime` datetime NULL DEFAULT NULL COMMENT '回传时间',
...
CREATE TABLE `order`  (
  ...
  `LastModTime` datetime NULL DEFAULT NULL COMMENT '最后操作时间',
...
CREATE TABLE `orderdetail`  (
  ...
  `LeaveDate` datetime NULL DEFAULT NULL COMMENT '离开日期',
  `MyType` int(11) NOT NULL COMMENT '系统类型',
  PRIMARY KEY (`Id`) USING BTREE
...
CREATE TABLE `tagsdetail`  (
  ...
  `RId` int(11) NOT NULL DEFAULT 0 COMMENT '目标Id',
  `AddTime` datetime NULL DEFAULT NULL COMMENT '添加时间',
  PRIMARY KEY (`Id`) USING BTREE,
  INDEX `IX_TagsDetail_TypeId`(`TypeId`) USING BTREE
) ENGINE = InnoDB AUTO_INCREMENT = 1 CHARACTER SET = utf8mb4 COLLATE = utf8mb4_general_ci COMMENT = 'Tag标签详情' ROW_FORMAT = Dynamic;

-- ----------------------------
-- Records of tagsdetail
-- ----------------------------
...
-- ----------------------------
-- Records of weixinresponsecontent
-- ----------------------------
...
CREATE TABLE `withdraworder`  (
  ...
  `AddTime` datetime NULL DEFAULT NULL COMMENT '时间',
