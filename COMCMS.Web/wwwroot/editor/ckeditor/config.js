...
CKEDITOR.editorConfig = function( config ) {
    ...
    config.disallowedContent = 'script; object; embed; iframe; *[on*]; a[href^="javascript:"]; img[src^="javascript:"]';
    ...
    config.toolbar_Common = [
        ...
        { name: 'insert', items: ['Image', 'html5video', 'Table', 'HorizontalRule', 'Smiley','emoji', 'SpecialChar'] },
        '/',
    ...
    config.removeButtons = 'ExportPdf,Save,NewPage,Templates,Flash,HiddenField,ImageButton,Button,Select,Textarea,TextField,Radio,Checkbox,Form,Language';
};
