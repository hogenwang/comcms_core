...
namespace COMCMS.Core
{
    ...
    [DataObject]
    [Description("快餐")]
    [BindTable("Food", Description = "快餐", ConnName = "dbconn", DbType = DatabaseType.SqlServer)]
    public partial class Food : IFood
    {
        #region 属性
        private Int32 _Id;
        /// <summary>编号</summary>
