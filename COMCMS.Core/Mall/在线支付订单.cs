...
namespace COMCMS.Core
{
    ...
    public partial class OnlinePayOrder : IOnlinePayOrder
    {
        ...
        [BindColumn("PayOrderNum", "在线支付订单号，唯一", "nvarchar(50)")]
        ...
        [Description("支付备注")]
        [DataObjectField(false, false, true, 250)]
        [BindColumn("PaymentNotes", "支付备注", "nvarchar(250)")]
        ...
        [Description("回传时间")]
        [DataObjectField(false, false, true, 0)]
        [BindColumn("ReceiveTime", "回传时间", "datetime")]
        ...
        [Description("订单标题")]
        [DataObjectField(false, false, true, 50)]
        [BindColumn("Title", "订单标题", "nvarchar(50)")]
        ...
        public override Object this[String name]
        {
            ...
            set
            {
                switch (name)
                {
                    ...
                    case __.ReceiveTime : _ReceiveTime = Convert.ToDateTime(value); break;
