...
namespace COMCMS.Core
{
    ...
    public partial class DataDictionary : Entity<DataDictionary>
    {
        #region 对象操作
        ...
        //static readonly FieldCache<DataDictionary> _CategoryCache = new FieldCache<DataDictionary>(_.Category)
        //{
