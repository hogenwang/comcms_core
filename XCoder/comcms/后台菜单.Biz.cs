...
namespace COMCMS.Core
{
    ...
    public partial class AdminMenu : Entity<AdminMenu>
    {
        ...
        // Select Count(Id) as Id,Category From AdminMenu Where CreateTime>'2020-01-24 00:00:00' Group By Category Order By Id Desc limit 20
        //static readonly FieldCache<AdminMenu> _CategoryCache = new FieldCache<AdminMenu>(nameof(Category))
        //{
