...
namespace COMCMS.Core
{
    ...
    public partial class Food : Entity<Food>
    {
        ...
        // Select Count(Id) as Id,Category From Food Where CreateTime>'2020-01-24 00:00:00' Group By Category Order By Id Desc limit 20
        //static readonly FieldCache<Food> _CategoryCache = new FieldCache<Food>(nameof(Category))
        //{
