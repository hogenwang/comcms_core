...
namespace COMCMS.Core
{
    ...
    public partial class HotelRoom
    {
        ...
        public String PriceList { get => _PriceList; set { if (OnPropertyChanging("PriceList", value)) { _PriceList = value; OnPropertyChanged("PriceList"); } } }
        #endregion
        ...
        public override Object this[String name]
        {
            get
            {
                switch (name)
                {
                    ...
                    case "PriceList": return _PriceList;
            ...
            set
            {
                switch (name)
                {
                    ...
                    case "PriceList": _PriceList = Convert.ToString(value); break;
        ...
        public partial class _
        {
            ...
            /// <summary>日期价格</summary>
            public static readonly Field PriceList = FindByName("PriceList");
