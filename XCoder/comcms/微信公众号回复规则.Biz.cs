...
namespace COMCMS.Core
{
    ...
    public partial class WeixinRequestRule : Entity<WeixinRequestRule>
    {
        ...
        // Select Count(Id) as Id,Category From WeixinRequestRule Where CreateTime>'2020-01-24 00:00:00' Group By Category Order By Id Desc limit 20
        //static readonly FieldCache<WeixinRequestRule> _CategoryCache = new FieldCache<WeixinRequestRule>(nameof(Category))
        //{
