...
namespace COMCMS.Core
{
    ...
    public partial class Tags : Entity<Tags>
    {
        ...
        {
            // 实体缓存
            if (Meta.Session.Count < 1000) return Meta.Cache.FindAll(e => e.TagName.EqualIgnoreCase(tagName));
        ...
        public static IList<Tags> Search(String tagName, String key, PageParameter page)
        {
            ...
            if (!key.IsNullOrEmpty()) exp &= _.TagName.Contains(key) | _.Keywords.Contains(key) | _.Description.Contains(key);
