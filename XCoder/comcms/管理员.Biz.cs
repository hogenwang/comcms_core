...
namespace COMCMS.Core
{
    ...
    public partial class Admin : Entity<Admin>
    {
        ...
        // Select Count(Id) as Id,Category From Admin Where CreateTime>'2020-01-24 00:00:00' Group By Category Order By Id Desc limit 20
        //static readonly FieldCache<Admin> _CategoryCache = new FieldCache<Admin>(nameof(Category))
        //{
