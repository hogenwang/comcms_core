...
namespace COMCMS.Core
{
    ...
    public partial class Article : Entity<Article>
    {
        ...
        // Select Count(Id) as Id,Category From Article Where CreateTime>'2020-01-24 00:00:00' Group By Category Order By Id Desc limit 20
        //static readonly FieldCache<Article> _CategoryCache = new FieldCache<Article>(nameof(Category))
        //{
