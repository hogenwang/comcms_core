...
namespace COMCMS.Core
{
    ...
    public partial class Shop : Entity<Shop>
    {
        ...
        public override void Valid(Boolean isNew)
        {
            ...
            ServiceScore = Math.Round(ServiceScore, 6);
            SpeedScore = Math.Round(SpeedScore, 6);
            EnvironmentScore = Math.Round(EnvironmentScore, 6);
        ...
        // Select Count(Id) as Id,Category From Shop Where CreateTime>'2020-01-24 00:00:00' Group By Category Order By Id Desc limit 20
        //static readonly FieldCache<Shop> _CategoryCache = new FieldCache<Shop>(nameof(Category))
        //{
