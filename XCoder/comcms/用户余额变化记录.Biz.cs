...
namespace COMCMS.Core
{
    ...
    public partial class BalanceChangeLog : Entity<BalanceChangeLog>
    {
        ...
        // Select Count(Id) as Id,Category From BalanceChangeLog Where CreateTime>'2020-01-24 00:00:00' Group By Category Order By Id Desc limit 20
        //static readonly FieldCache<BalanceChangeLog> _CategoryCache = new FieldCache<BalanceChangeLog>(nameof(Category))
        //{
