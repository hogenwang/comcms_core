...
namespace COMCMS.Core
{
    ...
    public partial class Department : Entity<Department>
    {
        ...
        // Select Count(Id) as Id,Category From Department Where CreateTime>'2020-01-24 00:00:00' Group By Category Order By Id Desc limit 20
        //static readonly FieldCache<Department> _CategoryCache = new FieldCache<Department>(_.Category)
        //{
