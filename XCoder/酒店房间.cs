...
{
    /// <summary>酒店房间</summary>
    [Serializable]
    [DataObject]
    [Description("酒店房间")]
    [BindTable("HotelRoom", Description = "酒店房间", ConnName = "dbconn", DbType = DatabaseType.SqlServer)]
    public partial class HotelRoom : IHotelRoom
    {
        #region 属性
        private Int32 _Id;
        /// <summary>编号</summary>
        ...
        [Description("品牌ID")]
        [DataObjectField(false, false, false, 0)]
        [BindColumn("BId", "品牌ID", "int")]
        public Int32 BId { get { return _BId; } set { if (OnPropertyChanging(__.BId, value)) { _BId = value; OnPropertyChanged(__.BId); } } }
        ...
        [Description("颜色ID")]
        [DataObjectField(false, false, false, 0)]
        [BindColumn("CId", "颜色ID", "int")]
        public Int32 CId { get { return _CId; } set { if (OnPropertyChanging(__.CId, value)) { _CId = value; OnPropertyChanged(__.CId); } } }
        ...
        [Description("供货商ID")]
        [DataObjectField(false, false, false, 0)]
        [BindColumn("SupportId", "供货商ID", "int")]
        public Int32 SupportId { get { return _SupportId; } set { if (OnPropertyChanging(__.SupportId, value)) { _SupportId = value; OnPropertyChanged(__.SupportId); } } }
        ...
        [Description("商品单位")]
        [DataObjectField(false, false, true, 250)]
        [BindColumn("Unit", "商品单位", "nvarchar(250)")]
        public String Unit { get { return _Unit; } set { if (OnPropertyChanging(__.Unit, value)) { _Unit = value; OnPropertyChanged(__.Unit); } } }
        ...
        [Description("商品规格尺寸")]
        [DataObjectField(false, false, true, 250)]
        [BindColumn("Spec", "商品规格尺寸", "nvarchar(250)")]
        ...
        [Description("颜色")]
        [DataObjectField(false, false, true, 250)]
        [BindColumn("Color", "颜色", "nvarchar(250)")]
        ...
        [Description("重量")]
        [DataObjectField(false, false, true, 50)]
        [BindColumn("Weight", "重量", "nvarchar(50)")]
        public String Weight { get { return _Weight; } set { if (OnPropertyChanging(__.Weight, value)) { _Weight = value; OnPropertyChanged(__.Weight); } } }
        ...
        [Description("市场价格")]
        [DataObjectField(false, false, false, 0)]
        [BindColumn("MarketPrice", "市场价格", "money")]
        ...
        [DataObjectField(false, false, false, 0)]
        [BindColumn("SpecialPrice", "特价，如有特价，以特价为准", "money")]
        ...
        [Description("材料")]
        [DataObjectField(false, false, true, 250)]
        [BindColumn("Material", "材料", "nvarchar(250)")]
        public String Material { get { return _Material; } set { if (OnPropertyChanging(__.Material, value)) { _Material = value; OnPropertyChanged(__.Material); } } }
        ...
        [Description("封面")]
        [DataObjectField(false, false, true, 250)]
        [BindColumn("Front", "封面", "nvarchar(250)")]
        public String Front { get { return _Front; } set { if (OnPropertyChanging(__.Front, value)) { _Front = value; OnPropertyChanged(__.Front); } } }
        ...
        [Description("积分")]
        [DataObjectField(false, false, false, 0)]
        [BindColumn("Credits", "积分", "int")]
        public Int32 Credits { get { return _Credits; } set { if (OnPropertyChanging(__.Credits, value)) { _Credits = value; OnPropertyChanged(__.Credits); } } }
        ...
        [Description("库存")]
        [DataObjectField(false, false, false, 0)]
        [BindColumn("Stock", "库存", "int")]
        public Int32 Stock { get { return _Stock; } set { if (OnPropertyChanging(__.Stock, value)) { _Stock = value; OnPropertyChanged(__.Stock); } } }
        ...
        [Description("警告库存")]
        [DataObjectField(false, false, false, 0)]
        [BindColumn("WarnStock", "警告库存", "int")]
        public Int32 WarnStock { get { return _WarnStock; } set { if (OnPropertyChanging(__.WarnStock, value)) { _WarnStock = value; OnPropertyChanged(__.WarnStock); } } }
        ...
        [Description("是否为子商品")]
        [DataObjectField(false, false, false, 0)]
        [BindColumn("IsSubProduct", "是否为子商品", "int")]
        public Int32 IsSubProduct { get { return _IsSubProduct; } set { if (OnPropertyChanging(__.IsSubProduct, value)) { _IsSubProduct = value; OnPropertyChanged(__.IsSubProduct); } } }
        ...
        [DataObjectField(false, false, false, 0)]
        [BindColumn("PPId", "父商品ID。如果为子商品，则需要填写父商品ID。实现多颜色功能", "int")]
        public Int32 PPId { get { return _PPId; } set { if (OnPropertyChanging(__.PPId, value)) { _PPId = value; OnPropertyChanged(__.PPId); } } }
        ...
        [Description("商品参数")]
        [DataObjectField(false, false, true, -1)]
        [BindColumn("Parameters", "商品参数", "ntext")]
        public String Parameters { get { return _Parameters; } set { if (OnPropertyChanging(__.Parameters, value)) { _Parameters = value; OnPropertyChanged(__.Parameters); } } }
        ...
        [Description("是否精华")]
        [DataObjectField(false, false, false, 0)]
        [BindColumn("IsBest", "是否精华", "int")]
        public Int32 IsBest { get { return _IsBest; } set { if (OnPropertyChanging(__.IsBest, value)) { _IsBest = value; OnPropertyChanged(__.IsBest); } } }
        ...
        [Description("是否新品")]
        [DataObjectField(false, false, false, 0)]
        [BindColumn("IsNew", "是否新品", "int")]
        public Int32 IsNew { get { return _IsNew; } set { if (OnPropertyChanging(__.IsNew, value)) { _IsNew = value; OnPropertyChanged(__.IsNew); } } }
        ...
        [Description("是否特价")]
        [DataObjectField(false, false, false, 0)]
        [BindColumn("IsSpecial", "是否特价", "int")]
        public Int32 IsSpecial { get { return _IsSpecial; } set { if (OnPropertyChanging(__.IsSpecial, value)) { _IsSpecial = value; OnPropertyChanged(__.IsSpecial); } } }
        ...
        [Description("是否促销")]
        [DataObjectField(false, false, false, 0)]
        [BindColumn("IsPromote", "是否促销", "int")]
        public Int32 IsPromote { get { return _IsPromote; } set { if (OnPropertyChanging(__.IsPromote, value)) { _IsPromote = value; OnPropertyChanged(__.IsPromote); } } }
        ...
        [Description("是否热销")]
        [DataObjectField(false, false, false, 0)]
        [BindColumn("IsHotSales", "是否热销", "int")]
        public Int32 IsHotSales { get { return _IsHotSales; } set { if (OnPropertyChanging(__.IsHotSales, value)) { _IsHotSales = value; OnPropertyChanged(__.IsHotSales); } } }
        ...
        [Description("是否缺货")]
        [DataObjectField(false, false, false, 0)]
        [BindColumn("IsBreakup", "是否缺货", "int")]
        public Int32 IsBreakup { get { return _IsBreakup; } set { if (OnPropertyChanging(__.IsBreakup, value)) { _IsBreakup = value; OnPropertyChanged(__.IsBreakup); } } }
        ...
        [Description("是否下架")]
        [DataObjectField(false, false, false, 0)]
        [BindColumn("IsShelves", "是否下架", "int")]
        public Int32 IsShelves { get { return _IsShelves; } set { if (OnPropertyChanging(__.IsShelves, value)) { _IsShelves = value; OnPropertyChanged(__.IsShelves); } } }
        ...
        [DataObjectField(false, false, false, 0)]
        [BindColumn("IsVerify", "是否审核，1为已经审核前台显示", "int")]
        ...
        [Description("是否为礼品商品")]
        [DataObjectField(false, false, false, 0)]
        [BindColumn("IsGift", "是否为礼品商品", "int")]
        public Int32 IsGift { get { return _IsGift; } set { if (OnPropertyChanging(__.IsGift, value)) { _IsGift = value; OnPropertyChanged(__.IsGift); } } }
        ...
        [Description("是否为配件")]
        [DataObjectField(false, false, false, 0)]
        [BindColumn("IsPart", "是否为配件", "int")]
        public Int32 IsPart { get { return _IsPart; } set { if (OnPropertyChanging(__.IsPart, value)) { _IsPart = value; OnPropertyChanged(__.IsPart); } } }
        ...
        [Description("评论数量")]
        [DataObjectField(false, false, false, 0)]
        [BindColumn("CommentCount", "评论数量", "int")]
        public Int32 CommentCount { get { return _CommentCount; } set { if (OnPropertyChanging(__.CommentCount, value)) { _CommentCount = value; OnPropertyChanged(__.CommentCount); } } }
        ...
        [Description("更多图片")]
        [DataObjectField(false, false, true, -1)]
        [BindColumn("ItemImg", "更多图片", "ntext")]
        public String ItemImg { get { return _ItemImg; } set { if (OnPropertyChanging(__.ItemImg, value)) { _ItemImg = value; OnPropertyChanged(__.ItemImg); } } }
        ...
        [Description("售后服务")]
        [DataObjectField(false, false, true, -1)]
        [BindColumn("Service", "售后服务", "ntext")]
        public String Service { get { return _Service; } set { if (OnPropertyChanging(__.Service, value)) { _Service = value; OnPropertyChanged(__.Service); } } }
        ...
        [Description("添加管理员ID")]
        [DataObjectField(false, false, false, 0)]
        [BindColumn("AuthorId", "添加管理员ID", "int")]
        public Int32 AuthorId { get { return _AuthorId; } set { if (OnPropertyChanging(__.AuthorId, value)) { _AuthorId = value; OnPropertyChanged(__.AuthorId); } } }
        ...
        [Description("存放目录")]
        [DataObjectField(false, false, true, 100)]
        [BindColumn("FilePath", "存放目录", "nvarchar(100)")]
        ...
        /// <summary>日期价格</summary>
        [DisplayName("日期价格")]
        [Description("日期价格")]
        [DataObjectField(false, false, true, -1)]
        [BindColumn("PriceList", "日期价格", "ntext")]
        public String PriceList { get { return _PriceList; } set { if (OnPropertyChanging(__.PriceList, value)) { _PriceList = value; OnPropertyChanged(__.PriceList); } } }
        #endregion
        ...
        public override Object this[String name]
        {
            get
            {
                switch (name)
                {
                    ...
                    case __.PriceList : return _PriceList;
            ...
            set
            {
                switch (name)
                {
                    ...
                    case __.BId : _BId = Convert.ToInt32(value); break;
                    case __.ShopId : _ShopId = Convert.ToInt32(value); break;
                    case __.CId : _CId = Convert.ToInt32(value); break;
                    case __.SupportId : _SupportId = Convert.ToInt32(value); break;
                    ...
                    case __.Stock : _Stock = Convert.ToInt32(value); break;
                    case __.WarnStock : _WarnStock = Convert.ToInt32(value); break;
                    case __.IsSubProduct : _IsSubProduct = Convert.ToInt32(value); break;
                    case __.PPId : _PPId = Convert.ToInt32(value); break;
                    ...
                    case __.IsBest : _IsBest = Convert.ToInt32(value); break;
                    case __.IsComment : _IsComment = Convert.ToInt32(value); break;
                    case __.IsMember : _IsMember = Convert.ToInt32(value); break;
                    case __.IsNew : _IsNew = Convert.ToInt32(value); break;
                    case __.IsSpecial : _IsSpecial = Convert.ToInt32(value); break;
                    case __.IsPromote : _IsPromote = Convert.ToInt32(value); break;
                    case __.IsHotSales : _IsHotSales = Convert.ToInt32(value); break;
                    case __.IsBreakup : _IsBreakup = Convert.ToInt32(value); break;
                    case __.IsShelves : _IsShelves = Convert.ToInt32(value); break;
                    case __.IsVerify : _IsVerify = Convert.ToInt32(value); break;
                    case __.Hits : _Hits = Convert.ToInt32(value); break;
                    case __.IsGift : _IsGift = Convert.ToInt32(value); break;
                    case __.IsPart : _IsPart = Convert.ToInt32(value); break;
                    ...
                    case __.PriceList : _PriceList = Convert.ToString(value); break;
        ...
        #region 字段名
        /// <summary>取得酒店房间字段信息的快捷方式</summary>
        public partial class _
        {
            ...
            /// <summary>日期价格</summary>
            public static readonly Field PriceList = FindByName(__.PriceList);

            static Field FindByName(String name) { return Meta.Table.FindByName(name); }
        }

        /// <summary>取得酒店房间字段名称的快捷方式</summary>
    ...
    /// <summary>酒店房间接口</summary>
    public partial interface IHotelRoom
    {
        #region 属性
        /// <summary>编号</summary>
        Int32 Id { get; set; }
