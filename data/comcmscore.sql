/*
 ...
 Source Schema         : comcmscore

 Target Server Type    : MySQL
 Target Server Version : 50721
 File Encoding         : 65001

 Date: 18/04/2018 20:38:13
*/
...
CREATE TABLE `admin`  (
  ...
  `RealName` varchar(20) CHARACTER SET utf8 COLLATE utf8_general_ci DEFAULT NULL COMMENT '姓名',
  ...
  `LastLoginIP` varchar(20) CHARACTER SET utf8 COLLATE utf8_general_ci DEFAULT NULL COMMENT '上次登录IP',
  `ThisLoginTime` datetime(0) DEFAULT NULL COMMENT '本次登录时间',
  `ThisLoginIP` varchar(20) CHARACTER SET utf8 COLLATE utf8_general_ci DEFAULT NULL COMMENT '本次登录IP',
...
-- Records of admin
-- ----------------------------
INSERT INTO `admin` VALUES (1, 'admin', '8788C77C8FA36CF9D3718026355AB571', 'fOtOFYYpLO90', 'admin', '', '', 100, 1, 0, '2018-04-18 18:06:51', '127.0.0.1', '2018-04-16 00:17:43', '127.0.0.1', 0);
...
CREATE TABLE `adminlog`  (
  ...
  `GUID` varchar(50) CHARACTER SET utf8 COLLATE utf8_general_ci DEFAULT NULL COMMENT '唯一ID',
  `UserName` varchar(20) CHARACTER SET utf8 COLLATE utf8_general_ci DEFAULT NULL COMMENT '用户名',
  `PassWord` varchar(50) CHARACTER SET utf8 COLLATE utf8_general_ci DEFAULT NULL COMMENT '密码',
  ...
  `Actions` text CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci COMMENT '记录',
  `LastUpdateTime` datetime(0) DEFAULT NULL COMMENT '登录时间',
  PRIMARY KEY (`Id`) USING BTREE
) ENGINE = InnoDB AUTO_INCREMENT = 28 CHARACTER SET = utf8mb4 COLLATE = utf8mb4_general_ci COMMENT = '管理日志表' ROW_FORMAT = Dynamic;
...
CREATE TABLE `adminmenu`  (
  `Id` int(11) NOT NULL AUTO_INCREMENT COMMENT '编号',
  `MenuKey` varchar(50) CHARACTER SET utf8 COLLATE utf8_general_ci DEFAULT NULL COMMENT '标识key',
  `MenuName` varchar(50) CHARACTER SET utf8 COLLATE utf8_general_ci DEFAULT NULL COMMENT '页面名称',
  `PermissionKey` varchar(50) CHARACTER SET utf8 COLLATE utf8_general_ci DEFAULT NULL COMMENT '页面名称',
  `Description` varchar(250) CHARACTER SET utf8 COLLATE utf8_general_ci DEFAULT NULL COMMENT '介绍',
  `Link` varchar(250) CHARACTER SET utf8 COLLATE utf8_general_ci DEFAULT NULL COMMENT '页面连接地址',
  `PId` int(11) NOT NULL COMMENT '上级ID',
  `Level` int(11) NOT NULL COMMENT '级别',
  `Location` varchar(100) CHARACTER SET utf8 COLLATE utf8_general_ci DEFAULT NULL COMMENT '路径',
  ...
  `ClassName` varchar(50) CHARACTER SET utf8 COLLATE utf8_general_ci DEFAULT NULL COMMENT '样式名称',
  PRIMARY KEY (`Id`) USING BTREE
...
CREATE TABLE `adminmenuevent`  (
  ...
  `MenuKey` varchar(100) CHARACTER SET utf8 COLLATE utf8_general_ci DEFAULT NULL COMMENT '菜单key',
  `EventId` int(11) NOT NULL COMMENT '事件ID',
  `EventKey` varchar(100) CHARACTER SET utf8 COLLATE utf8_general_ci DEFAULT NULL COMMENT '事件key',
  `EventName` varchar(100) CHARACTER SET utf8 COLLATE utf8_general_ci DEFAULT NULL COMMENT '事件名称',
  PRIMARY KEY (`Id`) USING BTREE
...
CREATE TABLE `adminroles`  (
  ...
  `RoleDescription` varchar(250) CHARACTER SET utf8 COLLATE utf8_general_ci DEFAULT NULL COMMENT '角色简单介绍',
  ...
  `Menus` text CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci COMMENT '管理菜单',
  `Powers` text CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci COMMENT '权限',
  PRIMARY KEY (`Id`) USING BTREE
...
CREATE TABLE `ads`  (
  `Id` int(11) NOT NULL AUTO_INCREMENT COMMENT '编号',
  `Title` varchar(100) CHARACTER SET utf8 COLLATE utf8_general_ci DEFAULT NULL COMMENT '广告标题',
  `Content` text CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci COMMENT '广告详情JSON',
  `KId` int(11) NOT NULL COMMENT '分类ID',
  `TId` int(11) NOT NULL COMMENT '广告代码类型：0代码、1文字广告、2图片广告、3Flash广告、4幻灯片广告、5漂浮广告、6对联浮动图片广告',
  `StartTime` datetime(0) DEFAULT NULL COMMENT '起始时间',
...
CREATE TABLE `adskind`  (
  `Id` int(11) NOT NULL AUTO_INCREMENT COMMENT '编号',
  `KindName` varchar(50) CHARACTER SET utf8 COLLATE utf8_general_ci DEFAULT NULL COMMENT '广告类别名称',
  `KindInfo` varchar(250) CHARACTER SET utf8 COLLATE utf8_general_ci DEFAULT NULL COMMENT '简单说明',
  `Rank` int(11) NOT NULL COMMENT '排序',
  PRIMARY KEY (`Id`) USING BTREE
...
CREATE TABLE `article`  (
  ...
  `Title` varchar(250) CHARACTER SET utf8 COLLATE utf8_general_ci DEFAULT NULL COMMENT '标题',
  `SubTitle` varchar(250) CHARACTER SET utf8 COLLATE utf8_general_ci DEFAULT NULL COMMENT '副标题',
  `Content` text CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci COMMENT '内容',
  `Keyword` varchar(250) CHARACTER SET utf8 COLLATE utf8_general_ci DEFAULT NULL COMMENT '描述',
  `Description` varchar(250) CHARACTER SET utf8 COLLATE utf8_general_ci DEFAULT NULL COMMENT '介绍',
  `LinkURL` varchar(250) CHARACTER SET utf8 COLLATE utf8_general_ci DEFAULT NULL COMMENT '跳转链接',
  `TitleColor` varchar(50) CHARACTER SET utf8 COLLATE utf8_general_ci DEFAULT NULL COMMENT '类别名称颜色',
  `TemplateFile` varchar(250) CHARACTER SET utf8 COLLATE utf8_general_ci DEFAULT NULL COMMENT '模板',
  ...
  `Icon` varchar(100) CHARACTER SET utf8 COLLATE utf8_general_ci DEFAULT NULL COMMENT '图标',
  `ClassName` varchar(50) CHARACTER SET utf8 COLLATE utf8_general_ci DEFAULT NULL COMMENT '样式名称',
  `BannerImg` varchar(250) CHARACTER SET utf8 COLLATE utf8_general_ci DEFAULT NULL COMMENT 'banner图片',
  `Pic` varchar(250) CHARACTER SET utf8 COLLATE utf8_general_ci DEFAULT NULL COMMENT '图片',
  `AdsId` int(11) NOT NULL COMMENT '广告ID',
  `Tags` varchar(250) CHARACTER SET utf8 COLLATE utf8_general_ci DEFAULT NULL COMMENT 'TAG',
  `Origin` varchar(250) CHARACTER SET utf8 COLLATE utf8_general_ci DEFAULT NULL COMMENT '来源',
  `OriginURL` varchar(250) CHARACTER SET utf8 COLLATE utf8_general_ci DEFAULT NULL COMMENT '来源地址',
  `ItemImg` text CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci COMMENT '更多图片',
  `AuthorId` int(11) NOT NULL COMMENT '添加管理员ID',
  `AddTime` datetime(0) DEFAULT NULL COMMENT '添加时间',
  `UpdateTime` datetime(0) DEFAULT NULL COMMENT '时间',
  `Location` varchar(100) CHARACTER SET utf8 COLLATE utf8_general_ci DEFAULT NULL COMMENT '路径',
  `FilePath` varchar(100) CHARACTER SET utf8 COLLATE utf8_general_ci DEFAULT NULL COMMENT '存放目录',
  PRIMARY KEY (`Id`) USING BTREE
) ENGINE = InnoDB AUTO_INCREMENT = 2 CHARACTER SET = utf8mb4 COLLATE = utf8mb4_general_ci COMMENT = '文章' ROW_FORMAT = Dynamic;
...
CREATE TABLE `articlecategory`  (
  `Id` int(11) NOT NULL AUTO_INCREMENT COMMENT '编号',
  `KindName` varchar(250) CHARACTER SET utf8 COLLATE utf8_general_ci DEFAULT NULL COMMENT '栏目名称',
  `SubTitle` varchar(250) CHARACTER SET utf8 COLLATE utf8_general_ci DEFAULT NULL COMMENT '栏目副标题',
  `KindTitle` varchar(250) CHARACTER SET utf8 COLLATE utf8_general_ci DEFAULT NULL COMMENT '栏目标题，填写则在浏览器替换此标题',
  `Keyword` varchar(250) CHARACTER SET utf8 COLLATE utf8_general_ci DEFAULT NULL COMMENT '描述',
  `Description` varchar(250) CHARACTER SET utf8 COLLATE utf8_general_ci DEFAULT NULL COMMENT '介绍',
  `LinkURL` varchar(250) CHARACTER SET utf8 COLLATE utf8_general_ci DEFAULT NULL COMMENT '跳转链接',
  `TitleColor` varchar(50) CHARACTER SET utf8 COLLATE utf8_general_ci DEFAULT NULL COMMENT '类别名称颜色',
  `TemplateFile` varchar(250) CHARACTER SET utf8 COLLATE utf8_general_ci DEFAULT NULL COMMENT '模板',
  `DetailTemplateFile` varchar(250) CHARACTER SET utf8 COLLATE utf8_general_ci DEFAULT NULL COMMENT '详情模板',
  `KindDomain` varchar(250) CHARACTER SET utf8 COLLATE utf8_general_ci DEFAULT NULL COMMENT '类别域名（保留）',
  ...
  `ClassName` varchar(50) CHARACTER SET utf8 COLLATE utf8_general_ci DEFAULT NULL COMMENT '样式名称',
  `BannerImg` varchar(250) CHARACTER SET utf8 COLLATE utf8_general_ci DEFAULT NULL COMMENT 'banner图片',
  `KindInfo` text CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci COMMENT '栏目详细介绍',
  `Pic` varchar(250) CHARACTER SET utf8 COLLATE utf8_general_ci DEFAULT NULL COMMENT '图片',
  `AdsId` int(11) NOT NULL COMMENT '广告ID',
  PRIMARY KEY (`Id`) USING BTREE
) ENGINE = InnoDB AUTO_INCREMENT = 2 CHARACTER SET = utf8mb4 COLLATE = utf8mb4_general_ci COMMENT = '文章栏目' ROW_FORMAT = Dynamic;
...
CREATE TABLE `balancechangelog`  (
  ...
  `UserName` varchar(20) CHARACTER SET utf8 COLLATE utf8_general_ci DEFAULT NULL COMMENT '用户名',
  `AddTime` datetime(0) DEFAULT NULL COMMENT '时间',
  `IP` varchar(20) CHARACTER SET utf8 COLLATE utf8_general_ci DEFAULT NULL COMMENT '登录IP',
  `Actions` varchar(100) CHARACTER SET utf8 COLLATE utf8_general_ci DEFAULT NULL COMMENT '记录',
  ...
  `LogDetails` varchar(250) CHARACTER SET utf8 COLLATE utf8_general_ci DEFAULT NULL COMMENT '详细记录',
...
CREATE TABLE `category`  (
  ...
  `AdsId` int(11) NOT NULL COMMENT '广告ID',
  PRIMARY KEY (`Id`) USING BTREE
) ENGINE = InnoDB AUTO_INCREMENT = 1 CHARACTER SET = utf8mb4 COLLATE = utf8mb4_general_ci COMMENT = '商品栏目' ROW_FORMAT = Dynamic;
...
CREATE TABLE `config`  (
  `Id` int(11) NOT NULL AUTO_INCREMENT COMMENT '编号',
  `SiteName` varchar(250) CHARACTER SET utf8 COLLATE utf8_general_ci DEFAULT NULL COMMENT '站点名称',
  `SiteUrl` varchar(50) CHARACTER SET utf8 COLLATE utf8_general_ci DEFAULT NULL COMMENT '站点URL',
  `SiteLogo` varchar(250) CHARACTER SET utf8 COLLATE utf8_general_ci DEFAULT NULL COMMENT '站点LOGO',
  `ICP` varchar(50) CHARACTER SET utf8 COLLATE utf8_general_ci DEFAULT NULL COMMENT 'ICP备案',
  `SiteEmail` varchar(100) CHARACTER SET utf8 COLLATE utf8_general_ci DEFAULT NULL COMMENT '联系我们Email',
  `SiteTel` varchar(50) CHARACTER SET utf8 COLLATE utf8_general_ci DEFAULT NULL COMMENT '网站电话',
  `Copyright` text CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci COMMENT '版权所有',
  `IsCloseSite` enum('N','Y') CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NOT NULL COMMENT '是否关闭网站',
  `CloseReason` text CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci COMMENT '关闭原因',
  `CountScript` text CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci COMMENT '统计代码',
  `WeiboQRCode` varchar(250) CHARACTER SET utf8 COLLATE utf8_general_ci DEFAULT NULL COMMENT '微博二维码',
  `WinxinQRCode` varchar(250) CHARACTER SET utf8 COLLATE utf8_general_ci DEFAULT NULL COMMENT '微信二维码',
  `Keyword` varchar(250) CHARACTER SET utf8 COLLATE utf8_general_ci DEFAULT NULL COMMENT '关键字',
  `Description` varchar(250) CHARACTER SET utf8 COLLATE utf8_general_ci DEFAULT NULL COMMENT '描述',
  `IndexTitle` varchar(250) CHARACTER SET utf8 COLLATE utf8_general_ci DEFAULT NULL COMMENT '首页标题',
  `IsRewrite` int(11) NOT NULL COMMENT '是否URL地址重写',
  `SearchMinTime` int(11) NOT NULL COMMENT '搜索最小时间间距 秒',
  `OnlineQQ` varchar(250) CHARACTER SET utf8 COLLATE utf8_general_ci DEFAULT NULL COMMENT '在线QQ',
  `OnlineSkype` varchar(250) CHARACTER SET utf8 COLLATE utf8_general_ci DEFAULT NULL COMMENT '在线Skype',
  `OnlineWangWang` varchar(250) CHARACTER SET utf8 COLLATE utf8_general_ci DEFAULT NULL COMMENT '在线阿里旺旺',
  `SkinName` varchar(50) CHARACTER SET utf8 COLLATE utf8_general_ci DEFAULT NULL COMMENT '站点URL',
  `OfficialName` varchar(50) CHARACTER SET utf8 COLLATE utf8_general_ci DEFAULT NULL COMMENT '公众号名称',
  `OfficialDecsription` varchar(250) CHARACTER SET utf8 COLLATE utf8_general_ci DEFAULT NULL COMMENT '公众号介绍',
  `OfficialOriginalId` varchar(100) CHARACTER SET utf8 COLLATE utf8_general_ci DEFAULT NULL COMMENT '公众号原始ID',
  `WexinAccount` varchar(50) CHARACTER SET utf8 COLLATE utf8_general_ci DEFAULT NULL COMMENT '微信名称',
  `Token` varchar(100) CHARACTER SET utf8 COLLATE utf8_general_ci DEFAULT NULL COMMENT 'Token',
  `AppId` varchar(100) CHARACTER SET utf8 COLLATE utf8_general_ci DEFAULT NULL COMMENT 'AppId',
  `AppSecret` varchar(100) CHARACTER SET utf8 COLLATE utf8_general_ci DEFAULT NULL COMMENT 'AppSecret',
  `FllowTipPageURL` varchar(250) CHARACTER SET utf8 COLLATE utf8_general_ci DEFAULT NULL COMMENT '引导关注素材地址',
  `OfficialType` int(11) NOT NULL COMMENT '公众号类型：0普通订阅号  1普通服务号  2认证订阅号  3认证服务号 4企业号 5认证企业号',
  `EncodingAESKey` varchar(250) CHARACTER SET utf8 COLLATE utf8_general_ci DEFAULT NULL COMMENT 'EncodingAESKey',
  `DEType` int(11) NOT NULL COMMENT '解密方式0,明文',
  `OfficialQRCode` varchar(250) CHARACTER SET utf8 COLLATE utf8_general_ci DEFAULT NULL COMMENT '公众号二维码地址',
  `OfficialImg` varchar(250) CHARACTER SET utf8 COLLATE utf8_general_ci DEFAULT NULL COMMENT '公众号头像',
  `LastUpdateTime` datetime(0) DEFAULT NULL COMMENT '最后更新时间',
  `LastCacheTime` datetime(0) DEFAULT NULL COMMENT '最后缓存时间',
  `MCHId` varchar(100) CHARACTER SET utf8 COLLATE utf8_general_ci DEFAULT NULL COMMENT '微信商家MCHId',
  `MCHKey` varchar(100) CHARACTER SET utf8 COLLATE utf8_general_ci DEFAULT NULL COMMENT '微信商家key',
  `DefaultFare` decimal(10, 0) NOT NULL COMMENT '默认运费',
  `MaxFreeFare` decimal(10, 0) NOT NULL COMMENT '最大免运费金额',
  `WXAppId` varchar(100) CHARACTER SET utf8 COLLATE utf8_general_ci DEFAULT NULL COMMENT '微信小程序AppId',
  `WXAppSecret` varchar(100) CHARACTER SET utf8 COLLATE utf8_general_ci DEFAULT NULL COMMENT '微信小程序AppSecret',
...
-- Records of config
-- ----------------------------
INSERT INTO `config` VALUES (1, 'COMCMS', 'http://www.comcms.com', NULL, '', NULL, NULL, NULL, 'N', NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, 0, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, NULL, 0, NULL, NULL, '2018-04-16 00:55:58', '2018-04-16 00:55:58', NULL, NULL, 0, 0, NULL, NULL, 0);
...
CREATE TABLE `coupon`  (
  `Id` int(11) NOT NULL AUTO_INCREMENT COMMENT '编号',
  `ItemNO` varchar(20) CHARACTER SET utf8 COLLATE utf8_general_ci DEFAULT NULL COMMENT '券号',
  ...
  `AddTime` datetime(0) DEFAULT NULL COMMENT '添加时间',
  `StartTime` datetime(0) DEFAULT NULL COMMENT '添加时间',
  `EndTime` datetime(0) DEFAULT NULL COMMENT '添加时间',
...
CREATE TABLE `couponkind`  (
  `Id` int(11) NOT NULL AUTO_INCREMENT COMMENT '编号',
  `IsLimit` int(11) NOT NULL COMMENT '是否有类别限制，0 无限制；1 是类别限制，2是商品限制',
  `KindName` varchar(200) CHARACTER SET utf8 COLLATE utf8_general_ci DEFAULT NULL COMMENT '类别名称',
  `CouponType` int(11) NOT NULL COMMENT '优惠券类型，0 现金用券，1打折券',
  `KIds` text CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci COMMENT '类别按逗号分开',
  `PIds` text CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci COMMENT '商品ID，按逗号分开',
  `KindNote` varchar(250) CHARACTER SET utf8 COLLATE utf8_general_ci DEFAULT NULL COMMENT '类别说明',
  `AddTime` datetime(0) DEFAULT NULL COMMENT '添加时间',
  `MyType` int(11) NOT NULL COMMENT '可使用类型',
  PRIMARY KEY (`Id`) USING BTREE
...
CREATE TABLE `couponuselog`  (
  ...
  `ItemNO` varchar(20) CHARACTER SET utf8 COLLATE utf8_general_ci DEFAULT NULL COMMENT '优惠券编号',
  `OrderNum` varchar(50) CHARACTER SET utf8 COLLATE utf8_general_ci DEFAULT NULL COMMENT '订单号',
  ...
  `Title` varchar(200) CHARACTER SET utf8 COLLATE utf8_general_ci DEFAULT NULL COMMENT '订单名称',
  `AddTime` datetime(0) DEFAULT NULL COMMENT '时间',
  `IP` varchar(20) CHARACTER SET utf8 COLLATE utf8_general_ci DEFAULT NULL COMMENT '登录IP',
  `Actions` varchar(250) CHARACTER SET utf8 COLLATE utf8_general_ci DEFAULT NULL COMMENT '记录详情',
  PRIMARY KEY (`Id`) USING BTREE
...
CREATE TABLE `food`  (
  ...
  `Title` varchar(250) CHARACTER SET utf8 COLLATE utf8_general_ci DEFAULT NULL COMMENT '标题',
  `ItemNO` varchar(50) CHARACTER SET utf8 COLLATE utf8_general_ci DEFAULT NULL COMMENT '编号',
  `SubTitle` varchar(250) CHARACTER SET utf8 COLLATE utf8_general_ci DEFAULT NULL COMMENT '副标题',
  `Unit` varchar(250) CHARACTER SET utf8 COLLATE utf8_general_ci DEFAULT NULL COMMENT '商品单位',
  `Spec` varchar(250) CHARACTER SET utf8 COLLATE utf8_general_ci DEFAULT NULL COMMENT '商品规格尺寸',
  `Color` varchar(250) CHARACTER SET utf8 COLLATE utf8_general_ci DEFAULT NULL COMMENT '颜色',
  `Weight` varchar(50) CHARACTER SET utf8 COLLATE utf8_general_ci DEFAULT NULL COMMENT '重量',
  ...
  `Material` varchar(250) CHARACTER SET utf8 COLLATE utf8_general_ci DEFAULT NULL COMMENT '材料',
  `Front` varchar(250) CHARACTER SET utf8 COLLATE utf8_general_ci DEFAULT NULL COMMENT '封面',
  ...
  `Content` text CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci COMMENT '内容',
  `Parameters` text CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci COMMENT '商品参数',
  `Keyword` varchar(250) CHARACTER SET utf8 COLLATE utf8_general_ci DEFAULT NULL COMMENT '描述',
  `Description` varchar(250) CHARACTER SET utf8 COLLATE utf8_general_ci DEFAULT NULL COMMENT '介绍',
  `LinkURL` varchar(250) CHARACTER SET utf8 COLLATE utf8_general_ci DEFAULT NULL COMMENT '跳转链接',
  `TitleColor` varchar(50) CHARACTER SET utf8 COLLATE utf8_general_ci DEFAULT NULL COMMENT '类别名称颜色',
  ...
  `Tags` varchar(250) CHARACTER SET utf8 COLLATE utf8_general_ci DEFAULT NULL COMMENT 'TAG',
  `ItemImg` text CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci COMMENT '更多图片',
  `Service` text CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci COMMENT '售后服务',
  `AuthorId` int(11) NOT NULL COMMENT '添加管理员ID',
  `AddTime` datetime(0) DEFAULT NULL COMMENT '添加时间',
  `UpdateTime` datetime(0) DEFAULT NULL COMMENT '时间',
  `Location` varchar(100) CHARACTER SET utf8 COLLATE utf8_general_ci DEFAULT NULL COMMENT '路径',
...
CREATE TABLE `guestbook`  (
  ...
  `KId` int(11) NOT NULL COMMENT '分类ID',
  `UId` int(11) NOT NULL COMMENT '用户ID',
  `Title` varchar(250) CHARACTER SET utf8 COLLATE utf8_general_ci DEFAULT NULL COMMENT '留言标题',
  `Content` text CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci COMMENT '详细介绍',
  `AddTime` datetime(0) DEFAULT NULL COMMENT '添加时间',
  ...
  `Tel` varchar(50) CHARACTER SET utf8 COLLATE utf8_general_ci DEFAULT NULL COMMENT '电话',
  `QQ` varchar(20) CHARACTER SET utf8 COLLATE utf8_general_ci DEFAULT NULL COMMENT 'QQ',
  `Skype` varchar(100) CHARACTER SET utf8 COLLATE utf8_general_ci DEFAULT NULL COMMENT 'Skype',
  `HomePage` varchar(250) CHARACTER SET utf8 COLLATE utf8_general_ci DEFAULT NULL COMMENT '主页',
  `Address` varchar(250) CHARACTER SET utf8 COLLATE utf8_general_ci DEFAULT NULL COMMENT '地址',
  `Company` varchar(250) CHARACTER SET utf8 COLLATE utf8_general_ci DEFAULT NULL COMMENT '公司',
  `ReplyTitle` varchar(250) CHARACTER SET utf8 COLLATE utf8_general_ci DEFAULT NULL COMMENT '回复标题',
  `ReplyContent` text CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci COMMENT '回复的详情',
  `ReplyAddTime` datetime(0) DEFAULT NULL COMMENT '回复时间',
  `ReplyIP` varchar(20) CHARACTER SET utf8 COLLATE utf8_general_ci DEFAULT NULL COMMENT '用户回复IP',
  `ReplyAdminId` int(11) NOT NULL COMMENT '用户的管理员ID',
  `ReplyNickName` varchar(20) CHARACTER SET utf8 COLLATE utf8_general_ci DEFAULT NULL COMMENT '回复者昵称',
  PRIMARY KEY (`Id`) USING BTREE
...
CREATE TABLE `guestbookcategory`  (
  `Id` int(11) NOT NULL AUTO_INCREMENT COMMENT '编号',
  `KindName` varchar(50) CHARACTER SET utf8 COLLATE utf8_general_ci DEFAULT NULL COMMENT '类别名称',
  `KindInfo` varchar(250) CHARACTER SET utf8 COLLATE utf8_general_ci DEFAULT NULL COMMENT '简单说明',
  `Pic` varchar(250) CHARACTER SET utf8 COLLATE utf8_general_ci DEFAULT NULL COMMENT '分类图片',
  `Rank` int(11) NOT NULL COMMENT '排序',
  PRIMARY KEY (`Id`) USING BTREE
...
CREATE TABLE `hotelroom`  (
  ...
  `Location` varchar(100) CHARACTER SET utf8 COLLATE utf8_general_ci DEFAULT NULL COMMENT '路径',
  `FilePath` varchar(100) CHARACTER SET utf8 COLLATE utf8_general_ci DEFAULT NULL COMMENT '存放目录',
  `PriceList` text CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci COMMENT '日期价格',
  PRIMARY KEY (`Id`) USING BTREE
...
CREATE TABLE `link`  (
  `Id` int(11) NOT NULL AUTO_INCREMENT COMMENT '编号',
  `KId` int(11) NOT NULL COMMENT '分类ID',
  `Title` varchar(250) CHARACTER SET utf8 COLLATE utf8_general_ci DEFAULT NULL COMMENT '站点标题',
  `LinkURL` varchar(250) CHARACTER SET utf8 COLLATE utf8_general_ci DEFAULT NULL COMMENT '站点连接',
  `Info` varchar(250) CHARACTER SET utf8 COLLATE utf8_general_ci DEFAULT NULL COMMENT '介绍',
  `Logo` varchar(250) CHARACTER SET utf8 COLLATE utf8_general_ci DEFAULT NULL COMMENT '站点LOGO',
...
CREATE TABLE `member`  (
  ...
  `Salt` varchar(20) CHARACTER SET utf8 COLLATE utf8_general_ci DEFAULT NULL COMMENT '盐值',
  `RealName` varchar(20) CHARACTER SET utf8 COLLATE utf8_general_ci DEFAULT NULL COMMENT '姓名',
  `Tel` varchar(20) CHARACTER SET utf8 COLLATE utf8_general_ci DEFAULT NULL COMMENT '手机',
  `Email` varchar(100) CHARACTER SET utf8 COLLATE utf8_general_ci DEFAULT NULL COMMENT '邮件',
  ...
  `UserImg` varchar(250) CHARACTER SET utf8 COLLATE utf8_general_ci DEFAULT NULL COMMENT '头像',
  ...
  `QQ` varchar(20) CHARACTER SET utf8 COLLATE utf8_general_ci DEFAULT NULL COMMENT 'QQ',
  `Weixin` varchar(50) CHARACTER SET utf8 COLLATE utf8_general_ci DEFAULT NULL COMMENT '微信',
  `Alipay` varchar(50) CHARACTER SET utf8 COLLATE utf8_general_ci DEFAULT NULL COMMENT '支付宝',
  `Skype` varchar(100) CHARACTER SET utf8 COLLATE utf8_general_ci DEFAULT NULL COMMENT 'skype',
  `Homepage` varchar(100) CHARACTER SET utf8 COLLATE utf8_general_ci DEFAULT NULL COMMENT '主页',
  `Company` varchar(100) CHARACTER SET utf8 COLLATE utf8_general_ci DEFAULT NULL COMMENT '公司',
  `IDNO` varchar(20) CHARACTER SET utf8 COLLATE utf8_general_ci DEFAULT NULL COMMENT '身份证',
  ...
  `District` varchar(50) CHARACTER SET utf8 COLLATE utf8_general_ci DEFAULT NULL COMMENT '区',
  `Address` varchar(250) CHARACTER SET utf8 COLLATE utf8_general_ci DEFAULT NULL COMMENT '详细地址',
  `Postcode` varchar(20) CHARACTER SET utf8 COLLATE utf8_general_ci DEFAULT NULL COMMENT '邮政编码',
  ...
  `RndNum` varchar(50) CHARACTER SET utf8 COLLATE utf8_general_ci DEFAULT NULL COMMENT '随机字符',
  `RePassWordTime` datetime(0) DEFAULT NULL COMMENT '找回密码时间',
  `Question` varchar(50) CHARACTER SET utf8 COLLATE utf8_general_ci DEFAULT NULL COMMENT '保密问题',
  `Answer` varchar(50) CHARACTER SET utf8 COLLATE utf8_general_ci DEFAULT NULL COMMENT '保密答案',
  ...
  `Bank` varchar(50) CHARACTER SET utf8 COLLATE utf8_general_ci DEFAULT NULL COMMENT '银行',
  `BankCardNO` varchar(50) CHARACTER SET utf8 COLLATE utf8_general_ci DEFAULT NULL COMMENT '银行卡号',
  `BankBranch` varchar(50) CHARACTER SET utf8 COLLATE utf8_general_ci DEFAULT NULL COMMENT '支行名称',
  `BankRealname` varchar(50) CHARACTER SET utf8 COLLATE utf8_general_ci DEFAULT NULL COMMENT '银行卡姓名',
  ...
  `WeixinOpenId` varchar(100) CHARACTER SET utf8 COLLATE utf8_general_ci DEFAULT NULL COMMENT '微信公众号OpenId',
  `WeixinAppOpenId` varchar(100) CHARACTER SET utf8 COLLATE utf8_general_ci DEFAULT NULL COMMENT '微信OpenId',
  `QQOpenId` varchar(100) CHARACTER SET utf8 COLLATE utf8_general_ci DEFAULT NULL COMMENT 'QQ OpenId',
  `WeiboOpenId` varchar(100) CHARACTER SET utf8 COLLATE utf8_general_ci DEFAULT NULL COMMENT '微博OpenId',
  PRIMARY KEY (`Id`) USING BTREE
...
CREATE TABLE `membercoupon`  (
  ...
  `UseTime` datetime(0) DEFAULT NULL COMMENT '使用时间',
  `OrderNum` varchar(50) CHARACTER SET utf8 COLLATE utf8_general_ci DEFAULT NULL COMMENT '订单号（使用后）',
...
CREATE TABLE `onlinepayorder`  (
  `Id` int(11) NOT NULL AUTO_INCREMENT COMMENT '编号',
  `PayOrderNum` varchar(50) CHARACTER SET utf8 COLLATE utf8_general_ci DEFAULT NULL COMMENT '在线支付订单号，唯一',
  `OrderId` int(11) NOT NULL COMMENT '订单ID',
  `OrderNum` varchar(50) CHARACTER SET utf8 COLLATE utf8_general_ci DEFAULT NULL COMMENT '订单号',
  `PayId` int(11) NOT NULL COMMENT '支付方式ID',
  `PayType` varchar(50) CHARACTER SET utf8 COLLATE utf8_general_ci DEFAULT NULL COMMENT '付款方式',
  `PayTypeNotes` varchar(250) CHARACTER SET utf8 COLLATE utf8_general_ci DEFAULT NULL COMMENT '支付备注',
  `Actions` varchar(200) CHARACTER SET utf8 COLLATE utf8_general_ci DEFAULT NULL COMMENT '日志记录',
  `UId` int(11) NOT NULL COMMENT '用户ID',
  `UserName` varchar(50) CHARACTER SET utf8 COLLATE utf8_general_ci DEFAULT NULL COMMENT '用户名',
  `TotalQty` int(11) NOT NULL COMMENT '总数量',
  `TotalPrice` decimal(10, 0) NOT NULL COMMENT '总价格',
  `PaymentStatus` varchar(50) CHARACTER SET utf8 COLLATE utf8_general_ci DEFAULT NULL COMMENT '支付状态：未支付、已支付、已退款',
  `PaymentNotes` varchar(250) CHARACTER SET utf8 COLLATE utf8_general_ci DEFAULT NULL COMMENT '支付备注',
  `IsOK` int(11) NOT NULL COMMENT '是否完成',
  `IP` varchar(20) CHARACTER SET utf8 COLLATE utf8_general_ci DEFAULT NULL COMMENT '下单IP',
  `AddTime` datetime(0) DEFAULT NULL COMMENT '添加时间',
  `ReceiveTime` datetime(0) DEFAULT NULL COMMENT '回传时间',
  `TypeId` int(11) NOT NULL COMMENT '支付的类型',
  `MyType` int(11) NOT NULL COMMENT '系统类型',
  `Title` varchar(50) CHARACTER SET utf8 COLLATE utf8_general_ci DEFAULT NULL COMMENT '订单标题',
  PRIMARY KEY (`Id`) USING BTREE
...
CREATE TABLE `order`  (
  ...
  `OrderNum` varchar(50) CHARACTER SET utf8 COLLATE utf8_general_ci DEFAULT NULL COMMENT '订单号',
  `UId` int(11) NOT NULL COMMENT '用户ID',
  `UserName` varchar(50) CHARACTER SET utf8 COLLATE utf8_general_ci DEFAULT NULL COMMENT '下单用户名',
  ...
  `AdminNotes` varchar(250) CHARACTER SET utf8 COLLATE utf8_general_ci DEFAULT NULL COMMENT '管理员备注',
  `Pic` text CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci COMMENT '图片',
  `DeliverId` int(11) NOT NULL COMMENT '配送方式ID',
  `DeliverType` varchar(50) CHARACTER SET utf8 COLLATE utf8_general_ci DEFAULT NULL COMMENT '配送方式名称',
  `DeliverNO` varchar(50) CHARACTER SET utf8 COLLATE utf8_general_ci DEFAULT NULL COMMENT '运单号',
  `DeliverNotes` varchar(250) CHARACTER SET utf8 COLLATE utf8_general_ci DEFAULT NULL COMMENT '配送备注',
  `PayId` int(11) NOT NULL COMMENT '支付方式ID',
  `PayType` varchar(50) CHARACTER SET utf8 COLLATE utf8_general_ci DEFAULT NULL COMMENT '付款方式',
  `PayTypeNotes` varchar(250) CHARACTER SET utf8 COLLATE utf8_general_ci DEFAULT NULL COMMENT '支付备注',
  `OrderStatus` varchar(50) CHARACTER SET utf8 COLLATE utf8_general_ci DEFAULT NULL COMMENT '订单状态：未确认、已确认、已完成、已取消',
  `PaymentStatus` varchar(50) CHARACTER SET utf8 COLLATE utf8_general_ci DEFAULT NULL COMMENT '支付状态：未支付、已支付、已退款',
  `DeliverStatus` varchar(50) CHARACTER SET utf8 COLLATE utf8_general_ci DEFAULT NULL COMMENT '配送状态：未配送、配货中、已配送、已收到、退货中、已退货',
  `AddTime` datetime(0) DEFAULT NULL COMMENT '添加时间',
  `IP` varchar(20) CHARACTER SET utf8 COLLATE utf8_general_ci DEFAULT NULL COMMENT '下单IP',
  `IsInvoice` int(11) NOT NULL COMMENT '是否需要发票',
  `InvoiceCompanyName` varchar(50) CHARACTER SET utf8 COLLATE utf8_general_ci DEFAULT NULL COMMENT '抬头',
  `InvoiceCompanyID` varchar(100) CHARACTER SET utf8 COLLATE utf8_general_ci DEFAULT NULL COMMENT '纳税人识别号',
  `InvoiceType` varchar(50) CHARACTER SET utf8 COLLATE utf8_general_ci DEFAULT NULL COMMENT '发票内容',
  `InvoiceNote` varchar(250) CHARACTER SET utf8 COLLATE utf8_general_ci DEFAULT NULL COMMENT '发票备注',
  ...
  `Flag1` varchar(200) CHARACTER SET utf8 COLLATE utf8_general_ci DEFAULT NULL COMMENT '预留字段1',
  `Flag2` varchar(200) CHARACTER SET utf8 COLLATE utf8_general_ci DEFAULT NULL COMMENT '预留字段2',
  `Flag3` varchar(200) CHARACTER SET utf8 COLLATE utf8_general_ci DEFAULT NULL COMMENT '预留字段3',
  `Title` varchar(200) CHARACTER SET utf8 COLLATE utf8_general_ci DEFAULT NULL COMMENT '订单名称',
  `LastModTime` datetime(0) DEFAULT NULL COMMENT '最后操作时间',
...
CREATE TABLE `orderdetail`  (
  ...
  `Title` varchar(250) CHARACTER SET utf8 COLLATE utf8_general_ci DEFAULT NULL COMMENT '商品名称',
  `Pic` varchar(250) CHARACTER SET utf8 COLLATE utf8_general_ci DEFAULT NULL COMMENT '商品名称',
  `Attr` varchar(250) CHARACTER SET utf8 COLLATE utf8_general_ci DEFAULT NULL COMMENT '商品属性',
  `Color` varchar(50) CHARACTER SET utf8 COLLATE utf8_general_ci DEFAULT NULL COMMENT '商品颜色',
  ...
  `AddTime` datetime(0) DEFAULT NULL COMMENT '添加时间',
  `CheckInDate` datetime(0) DEFAULT NULL COMMENT '入住日期',
...
CREATE TABLE `otherconfig`  (
  `Id` int(11) NOT NULL AUTO_INCREMENT COMMENT '编号',
  `ConfigName` varchar(50) CHARACTER SET utf8 COLLATE utf8_general_ci DEFAULT NULL COMMENT '配置名称',
  `ConfigValue` text CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci COMMENT '配置值 JSON',
  `LastUpdateTime` datetime(0) DEFAULT NULL COMMENT '最后更新时间',
  PRIMARY KEY (`Id`) USING BTREE
...
CREATE TABLE `shop`  (
  `Id` int(11) NOT NULL AUTO_INCREMENT COMMENT '编号',
  `ShopName` varchar(200) CHARACTER SET utf8 COLLATE utf8_general_ci DEFAULT NULL COMMENT '店铺名称',
  ...
  `Content` text CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci COMMENT '店铺介绍',
  `Keyword` varchar(250) CHARACTER SET utf8 COLLATE utf8_general_ci DEFAULT NULL COMMENT '关键字',
  `Description` varchar(250) CHARACTER SET utf8 COLLATE utf8_general_ci DEFAULT NULL COMMENT '描述',
  `BannerImg` varchar(250) CHARACTER SET utf8 COLLATE utf8_general_ci DEFAULT NULL COMMENT 'banner图片',
  ...
  `Pic` varchar(250) CHARACTER SET utf8 COLLATE utf8_general_ci DEFAULT NULL COMMENT '图片',
  `MorePics` text CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci COMMENT '店铺所有图片',
  `Email` varchar(100) CHARACTER SET utf8 COLLATE utf8_general_ci DEFAULT NULL COMMENT '邮箱',
  `Tel` varchar(50) CHARACTER SET utf8 COLLATE utf8_general_ci DEFAULT NULL COMMENT '电话',
  `Phone` varchar(50) CHARACTER SET utf8 COLLATE utf8_general_ci DEFAULT NULL COMMENT '固定电话',
  `QQ` varchar(20) CHARACTER SET utf8 COLLATE utf8_general_ci DEFAULT NULL COMMENT 'QQ',
  `Skype` varchar(100) CHARACTER SET utf8 COLLATE utf8_general_ci DEFAULT NULL COMMENT 'Skype',
  `HomePage` varchar(250) CHARACTER SET utf8 COLLATE utf8_general_ci DEFAULT NULL COMMENT '主页',
  `Weixin` varchar(50) CHARACTER SET utf8 COLLATE utf8_general_ci DEFAULT NULL COMMENT '微信',
  `IsShip` int(11) NOT NULL COMMENT '是否配送',
  `OpenTime` datetime(0) DEFAULT NULL COMMENT '开店时间',
  `CloseTime` datetime(0) DEFAULT NULL COMMENT '关店时间',
  `ShippingStartTime` datetime(0) DEFAULT NULL COMMENT '配送开始时间',
  `ShippingEndTime` datetime(0) DEFAULT NULL COMMENT '配送结束时间',
  `AddTime` datetime(0) DEFAULT NULL COMMENT '添加时间',
...
CREATE TABLE `shoppingcart`  (
  `Id` int(11) NOT NULL AUTO_INCREMENT COMMENT '编号',
  `UId` int(11) NOT NULL COMMENT '用户ID',
  `GUID` varchar(50) CHARACTER SET utf8 COLLATE utf8_general_ci DEFAULT NULL COMMENT '唯一GUID，没登录用户使用',
  `Details` text CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci COMMENT '购物车内容，JOSN',
  `AddTime` datetime(0) DEFAULT NULL COMMENT '加入购物车时间',
...
CREATE TABLE `targetevent`  (
  `Id` int(11) NOT NULL AUTO_INCREMENT COMMENT '编号',
  `EventKey` varchar(50) CHARACTER SET utf8 COLLATE utf8_general_ci DEFAULT NULL COMMENT '事件key',
  `EventName` varchar(50) CHARACTER SET utf8 COLLATE utf8_general_ci DEFAULT NULL COMMENT '事件名称',
...
CREATE TABLE `withdraworder`  (
  ...
  `OrderNum` varchar(50) CHARACTER SET utf8 COLLATE utf8_general_ci DEFAULT NULL COMMENT '订单号',
  `UserName` varchar(200) CHARACTER SET utf8 COLLATE utf8_general_ci DEFAULT NULL COMMENT '用户名',
  `Title` varchar(100) CHARACTER SET utf8 COLLATE utf8_general_ci DEFAULT NULL COMMENT '订单名称',
  `AddTime` datetime(0) DEFAULT NULL COMMENT '时间',
  `IP` varchar(20) CHARACTER SET utf8 COLLATE utf8_general_ci DEFAULT NULL COMMENT '登录IP',
  `Actions` varchar(250) CHARACTER SET utf8 COLLATE utf8_general_ci DEFAULT NULL COMMENT '记录详情',
  ...
  `VerifyTime` datetime(0) DEFAULT NULL COMMENT '审核时间',
  `FormId` varchar(50) CHARACTER SET utf8 COLLATE utf8_general_ci DEFAULT NULL COMMENT '小程序FormId',
  PRIMARY KEY (`Id`) USING BTREE
...
CREATE TABLE `wxappsession`  (
  ...
  `UId` int(11) NOT NULL COMMENT '用户ID',
  `IP` varchar(20) CHARACTER SET utf8 COLLATE utf8_general_ci DEFAULT NULL COMMENT '登录IP',
  `Key` varchar(50) CHARACTER SET utf8 COLLATE utf8_general_ci DEFAULT NULL COMMENT '系统生成Key',
  `SessionKey` varchar(50) CHARACTER SET utf8 COLLATE utf8_general_ci DEFAULT NULL COMMENT '微信SessionKey',
  `OpenId` varchar(50) CHARACTER SET utf8 COLLATE utf8_general_ci DEFAULT NULL COMMENT '微信小程序OpenId',
  `AddTime` datetime(0) DEFAULT NULL COMMENT '添加时间',
  PRIMARY KEY (`Id`) USING BTREE
